...
class Models{
  ...
  protected function __construct(){
    ...
    $this->ModelsData = json_decode(file_get_contents(__ROOT__.'/backend/api/model/Models.json'), true); //Getting model data
...
class ModelData{
  ...
  public function setModelData($ModelName, $ModelData){
    ...
    if($ModelData!=null and array_key_exists("login_field",$ModelData)){
